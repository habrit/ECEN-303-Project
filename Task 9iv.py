    ...
    if (mVisits != 0):
        ...
        if (mCustomers != 0):
            ...
            while(j < mCustomers):
                ...
                j = j + 1
    print(waitTime)
    if((waitTime > 20) & (mVisits >= 5) & (mCustomers > 1)):
        timesOverTwenty = timesOverTwenty + 1
    k = k + 1
print("The estimated probability of a wait time more than 20 minutes given Jane visits at least 5 times and there is one customer in front of her: ", ((timesOverTwenty)/(1000000)) * 100, "%")
